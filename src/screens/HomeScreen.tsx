    ...
    <View style={styles.container}>
      ...
      <ScrollView bounces={false}>
        ...
        <View style={styles.view5}>
          <View style={styles.view6}>
            ...
            <View>
              ...
              <Text style={{ color: colors.grey3 }}>Ajao Estate, Lagos</Text>
            </View>
          </View>
          <View>
            <Icon
        ...
        <View style={{ ...styles.view5, borderBottomWidth: 0 }}>
          <View style={styles.view6}>
            ...
            <View>
              ...
              <Text style={{ color: colors.grey3 }}>Bucknor, Lagos</Text>
            </View>
          </View>
          <View>
            <Icon
        ...
        <View style={{ alignItems: 'center', justifyContent: 'center' }}>
          ...
          >
            {carsAround.map((item, i) => (
              <Marker coordinate={item} key={item.latitude}>
                <Image
